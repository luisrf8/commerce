    ...
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeMobileMenu} className="relative z-50">
          ...
          <><div style={{ zIndex: 35,}} className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-[#404040] bg-black/30 p-6 backdrop-blur-xl md:w-[390px]" >
          ...
          {!cart || cart.length === 0 ? (
            ...
            <div className="flex h-full flex-col justify-between overflow-hidden">
              ...
              <ul className="flex-grow overflow-auto py-2">
                {cart.map((item, i) => {
                  return (
                    <li
                      key={i}
                      className="flex w-full flex-col border-b border-[#404040]"
                    >
                      <div className="relative flex w-full flex-row justify-between px-1 py-4">
                        ...
                        <div className="flex h-16 flex-col justify-between">
                          <Price
                            ...
                            amount={item.price}
                            />
                          <div className="ml-auto flex h-9 flex-row items-center rounded-full border border-neutral-700 border-[#404040]">
                            <button
              ...
              <div className="py-4 text-sm text-neutral-500 ">
                <div className="mb-3 flex items-center justify-between border-b dark:border-neutral-700 border-neutral-200 pb-1 pt-1 ">
                  <p>Sub Total</p>
                  <Price
